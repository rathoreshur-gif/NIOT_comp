...
def generate_launch_description():
    ...
    world_file = os.path.join(pkg_auv_worlds, 'worlds', 'mini_matsya.sdf')
    ...
    world_arg = DeclareLaunchArgument(
        ...
        description='/worlds/mini_matsya.sdf '  
    )
    ...
    bridge_config = os.path.join(pkg_auv_worlds, 'config', 'mini_bridge_topics_thrusters.yaml')
